...
export const metadata: Metadata = {
  title: "Security Policy - Body Shape Analyzer",
  description: "Security practices and data-protection approach for Body Shape Analyzer.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-16 max-w-4xl">
      ...
      <p className="text-lg mb-4">
        Protecting your data is important to us. This page outlines how Body Shape Analyzer approaches security and
        data protection.
      </p>
      ...
      <section className="mb-6">
        ...
        <p>
          Traffic to and from Body Shape Analyzer is intended to be served over HTTPS using modern TLS standards
