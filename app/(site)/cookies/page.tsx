...
export const metadata: Metadata = {
  title: "Cookie Policy - Jawline Check",
  description: "Cookie and similar technology usage for Jawline Check.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-16 max-w-4xl">
      ...
      <p className="text-lg mb-4">
        This page describes how Jawline Check may use cookies and similar technologies.
      </p>
