  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-16 max-w-4xl">
      ...
      <p className="mb-4 text-lg">
        These Terms govern your use of Body Shape Analyzer. By using this service, you agree to these terms.
      </p>
      ...
      <section className="mb-8">
        ...
        <p>
          Body Shape Analyzer is not a medical or diagnostic tool. Do not rely on it as a substitute for professional
          evaluation or official assessment.
        </p>
      </section>
